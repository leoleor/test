import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as c,c as p,b as n,d as s,e as a,w as u,f as t}from"./app-aa5ccc09.js";const r="/Lion_Blog/images/githubActions/jobs.png",d="/Lion_Blog/images/githubActions/demo.png",m="/Lion_Blog/images/githubActions/配置变量1.png",k="/Lion_Blog/images/githubActions/配置变量2.png",v="/Lion_Blog/images/githubActions/配置变量3.png",b="/Lion_Blog/images/githubActions/权限报错.png",g="/Lion_Blog/images/githubActions/权限1.png",h="/Lion_Blog/images/githubActions/权限2.png",y="/Lion_Blog/images/githubActions/选择构建.png",f="/Lion_Blog/images/githubActions/开始构建.png",_="/Lion_Blog/images/githubActions/完成.png",x={},A=n("h2",{id:"前言",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#前言","aria-hidden":"true"},"#"),s(" 前言")],-1),j=n("code",null,"Github Actions",-1),w=n("h2",{id:"准备工作",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#准备工作","aria-hidden":"true"},"#"),s(" 准备工作")],-1),G=n("li",null,[n("p",null,"准备一个 VuePress 网站")],-1),B={href:"https://link.juejin.cn/?target=https%3A%2F%2Fblog.csdn.net%2Fkangkanglhb88008%2Farticle%2Fdetails%2F127947544",title:"https://blog.csdn.net/kangkanglhb88008/article/details/127947544",target:"_blank",rel:"noopener noreferrer"},L={href:"https://blog.csdn.net/nxg0916/article/details/127271906",target:"_blank",rel:"noopener noreferrer"},H=t('<h2 id="了解-github-actions" tabindex="-1"><a class="header-anchor" href="#了解-github-actions" aria-hidden="true">#</a> 了解 Github Actions</h2><blockquote><p>GitHub Actions 是一种持续集成和持续交付 (CI/CD) 平台，可用于自动执行生成、测试和部署管道。 您可以创建工作流程来构建和测试存储库的每个拉取请求，或将合并的拉取请求部署到生产环境。</p><p>GitHub Actions 不仅仅是 DevOps，还允许您在存储库中发生其他事件时运行工作流程。 例如，您可以运行工作流程，以便在有人在您的存储库中创建新问题时自动添加相应的标签。</p><p>GitHub 提供 Linux、Windows 和 macOS 虚拟机来运行工作流程，或者您可以在自己的数据中心或云基础架构中托管自己的自托管运行器。</p></blockquote><p>Github Actions 功能强大，这篇文章主要教大家如何自动化部署，大白话就是：<code>提交完代码后，由Github去执行一系列运维工作，我们只需要等网站更新即可</code>。</p><h2 id="了解工作流语法" tabindex="-1"><a class="header-anchor" href="#了解工作流语法" aria-hidden="true">#</a> 了解工作流语法</h2>',4),z={href:"https://docs.github.com/zh/actions/using-workflows/about-workflows",target:"_blank",rel:"noopener noreferrer"},N=t(`<h3 id="name" tabindex="-1"><a class="header-anchor" href="#name" aria-hidden="true">#</a> name</h3><p>工作流的名称，如果省略，则使用当前文件名</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> Auto Deploy
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="on" tabindex="-1"><a class="header-anchor" href="#on" aria-hidden="true">#</a> on</h3>`,7),C={href:"https://docs.github.com/zh/actions/using-workflows/workflow-syntax-for-github-actions#on",target:"_blank",rel:"noopener noreferrer"},P=t(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">on</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每一个任务[my_first_job]下可以配置</p><ul><li><p><strong>name</strong> 任务的名称，不设置则默认[my_first_job]</p></li><li><p><strong>runs-on</strong> 运行所需要的虚拟机环境</p></li><li><p><strong>needs</strong> 各个任务间可以设置依赖关系</p></li><li><p><strong>steps</strong> 每个任务下的运行步骤，从上至下依次执行</p></li></ul><figure><img src="`+r+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',7),S={href:"https://docs.github.com/zh/actions/using-workflows/workflow-syntax-for-github-actions#jobs",target:"_blank",rel:"noopener noreferrer"},E=t('<h3 id="jobs-job-id-steps" tabindex="-1"><a class="header-anchor" href="#jobs-job-id-steps" aria-hidden="true">#</a> jobs.&lt;job_id&gt;.steps</h3><p>每一个步骤下可以设置</p><ul><li><p><strong>name</strong> 步骤名称</p></li><li><p><strong>run</strong> 需要运行的命令行程序 如：<code>npm run build</code></p></li><li><p><strong>uses</strong> 一般直接使用别人预先设置好的Actions 如：<code>actions/setup-node@v3</code> 用来安装Node环境</p></li><li><p><strong>with</strong> 使用不同的Actions需要不同的参数 如：<code>node-version: &#39;16&#39;</code> 用来选择安装的Node版本</p></li></ul><h2 id="创建工作流" tabindex="-1"><a class="header-anchor" href="#创建工作流" aria-hidden="true">#</a> 创建工作流</h2><p><strong>正片开始</strong> 为了感受完整流程，我重新创建了一个 VuePress 的demo</p><figure><img src="'+d+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>在项目根路径下的 <code>.github/workflows</code> 目录中创建一个 deploy.yml/deploy.yaml 文件（deploy可以自定义命名）</p><p>注意：<strong>如果你已经有代码仓库，是首次创建工作流，配置好后需要将其先提交到仓库，不然是不会运行工作流的。</strong></p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># 工作流的名称，如果省略，则使用当前文件名</span>
